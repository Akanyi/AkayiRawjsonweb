...
import { MODAL_INPUT_CLASSES, MODAL_LABEL_CLASSES, MODAL_GRID_CLASSES, MODAL_SECTION_TITLE_CLASSES, FAMILY_TYPES } from '../utils.js';

// ====== 简单对话框模板 ======

export function getCopyPreferencePromptTemplate(): string {
    return `
...
export function getAutoSavePromptTemplate(): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-sm">
...
export function getClearAllConfirmTemplate(): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-sm">
...
export function getSettingsModalTemplate(currentFormat: string, autoSaveEnabled: boolean): string {
    return `
...
export interface MockSettings {
    selectorNames: { [key: string]: string };
    scoreMockValue: string;
    translateMockValue: string;
    conditionMockValue: string;
}

export function getSimulatorModalTemplate(settings: MockSettings): string {
    return `
...
export function getAboutModalTemplate(changelogHtml: string): string {
    return `
...
export function getDecodeModalTemplate(): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
...
export function getScoreEditTemplate(name: string, objective: string): string {
    return `
...
export function getTranslateEditTemplate(translate: string, withValue: string): string {
    return `
...
export function wrapEditModalContent(innerContent: string): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md">
...
export function getRotationHelpTemplate(): string {
    return `
...
export function getDimensionHelpTemplate(): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md max-h-[80vh] overflow-y-auto text-gray-800 dark:text-gray-200">
            <div class="flex justify-between items-center mb-4">
...
export function getFamilyTypesDocTemplate(familyTypesHtml: string): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md max-h-[80vh] overflow-y-auto text-gray-800 dark:text-gray-200">
            <div class="flex justify-between items-center mb-4">
...
export function getItemSearchModalTemplate(itemsHtml: string): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md max-h-[80vh] overflow-y-auto text-gray-800 dark:text-gray-200">
            <div class="flex justify-between items-center mb-4">
...
export function getLocationSearchModalTemplate(slotsHtml: string): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md max-h-[80vh] overflow-y-auto text-gray-800 dark:text-gray-200">
            <div class="flex justify-between items-center mb-4">
...
export function getHasitemConditionItemTemplate(index: number, condition: any): string {
    return `
...
export function getHasitemEditorModalTemplate(conditionsHtml: string): string {
    return `
...
export function getScoreConditionItemTemplate(index: number, objective: string, value: string): string {
    return `
...
export function getScoreEditorModalTemplate(conditionsHtml: string): string {
    return `
        <div class="modal-content bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-4">
