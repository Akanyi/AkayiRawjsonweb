export class RichTextEditor {
    ...
    applySelectorEdit() {
        ...
        if (manualForm && !manualForm.classList.contains('hidden')) {
            ...
            selector = document.getElementById('manual-selector-input')?.value || '';
        }
        else if (advancedForm && !advancedForm.classList.contains('hidden')) {
            // Advanced mode is active
            const base = document.getElementById('sel-base')?.value || 'p';
            let params = [];
            ...
            const tagsInput = document.getElementById('sel-tag')?.value;
